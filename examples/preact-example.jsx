import { ThumbmarkProvider, useThumbmark, version } from '@thumbmarkjs/preact';
...
function App() {
  return (
    ...
    >
      <div>
        <h1>ThumbmarkJS Preact Example</h1>
        <div style={{
          fontSize: '14px',
          color: '#666',
          marginBottom: '20px',
          ...
          Using @thumbmarkjs/preact v{version} • @thumbmarkjs/thumbmarkjs v{getVersion()}
        </div>
        <ThumbmarkDisplay />
      </div>
    </ThumbmarkProvider>
